...
import net.mcreator.solomon.procedure.ProcedureLeirenDangShiTiGengXinKeShi;
...
public class EntityLeiren extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 68;
	public static final int ENTITYID_RANGED = 69;
	public EntityLeiren(ElementsSolomonMod instance) {
		super(instance, 133);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "leiren"), ENTITYID)
				.name("leiren").tracker(64, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureLeirenDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}

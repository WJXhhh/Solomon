...
import net.mcreator.solomon.procedure.ProcedureTianxingDangShiTiGengXinKeShi;
...
public class EntityTianxing extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 17;
	public static final int ENTITYID_RANGED = 18;
	public EntityTianxing(ElementsSolomonMod instance) {
		super(instance, 108);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "tianxing"), ENTITYID)
				.name("tianxing").tracker(64, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureTianxingDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}

...
import net.mcreator.solomon.procedure.ProcedureShougunren2DangShiTiGengXinKeShi;
...
public class EntityShougunren2 extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 72;
	public static final int ENTITYID_RANGED = 73;
	public EntityShougunren2(ElementsSolomonMod instance) {
		super(instance, 135);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("solomon", "shougunren_2"), ENTITYID).name("shougunren_2").tracker(64, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeldao1(), 0.5f) {
	...
	public static class EntityCustom extends EntityMob {
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureShougunren2DangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modeldao1 extends ModelBase {
		...
		public Modeldao1() {
			...
			setRotationAngle(cube_r1, 1.5708F, 1.2217F, 1.5708F);

...
import net.mcreator.solomon.procedure.ProcedureLanduoshituShiTiSiWangShi;
import net.mcreator.solomon.procedure.ProcedureLanduoshituDangShiTiGengXinKeShi;
...
public class EntityLanduoshitu extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 27;
	public static final int ENTITYID_RANGED = 28;
	public EntityLanduoshitu(ElementsSolomonMod instance) {
		super(instance, 113);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("solomon", "landuoshitu"), ENTITYID).name("landuoshitu").tracker(64, 3, true).egg(-1, -16750849).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("solomon:textures/ldst.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemLanduogengpai.block, (int) (1)).getItem();
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureLanduoshituShiTiSiWangShi.executeProcedure($_dependencies);
			}
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureLanduoshituDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}

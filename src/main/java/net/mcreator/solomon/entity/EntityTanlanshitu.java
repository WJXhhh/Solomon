...
import net.mcreator.solomon.procedure.ProcedureTanlanshitudanghsi;
import net.mcreator.solomon.procedure.ProcedureTanlanshituShiTiSiWangShi;
...
public class EntityTanlanshitu extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 11;
	public static final int ENTITYID_RANGED = 12;
	public EntityTanlanshitu(ElementsSolomonMod instance) {
		super(instance, 106);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("solomon", "tanlanshitu"), ENTITYID).name("tanlanshitu").tracker(64, 3, true).egg(-1, -26317).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("solomon:textures/tlst.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemTanglangnegpai.block, (int) (1)).getItem();
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureTanlanshituShiTiSiWangShi.executeProcedure($_dependencies);
			}
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureTanlanshitudanghsi.executeProcedure($_dependencies);
			}
		}

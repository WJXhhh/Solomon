...
import net.mcreator.solomon.procedure.ProcedureBaonushituShiTiSiWangShi;
import net.mcreator.solomon.procedure.ProcedureBaonushituDangShiTiGengXinKeShi;
...
public class EntityBaonushitu extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 35;
	public static final int ENTITYID_RANGED = 36;
	public EntityBaonushitu(ElementsSolomonMod instance) {
		super(instance, 117);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "baonushitu"), ENTITYID)
				.name("baonushitu").tracker(64, 3, true).egg(-1, -65536).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("solomon:textures/bnst.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemBaonugo.block, (int) (1)).getItem();
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureBaonushituShiTiSiWangShi.executeProcedure($_dependencies);
			}
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureBaonushituDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}

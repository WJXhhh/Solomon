...
import net.mcreator.solomon.procedure.ProcedureTartagliaShiTiSiWangShi;
import net.mcreator.solomon.procedure.ProcedureTartagliaDangShiTiGengXinKeShi;
import net.mcreator.solomon.item.ItemTartagliaBow;
...
public class EntityTartaglia extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 91;
	public static final int ENTITYID_RANGED = 92;
	public EntityTartaglia(ElementsSolomonMod instance) {
		super(instance, 144);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "tartaglia"), ENTITYID)
				.name("tartaglia").tracker(64, 3, true).egg(-1, -16737844).build());
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("solomon", "entitybullettartaglia"), ENTITYID_RANGED).name("entitybullettartaglia").tracker(64, 1, true)
				.build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("solomon:textures/tarta.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob implements IRangedAttackMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemTartagliaBow.block, (int) (1)));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureTartagliaShiTiSiWangShi.executeProcedure($_dependencies);
			}
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureTartagliaDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}

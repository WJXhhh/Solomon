...
public class EntityTianjieduan extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 37;
	public static final int ENTITYID_RANGED = 38;
	public EntityTianjieduan(ElementsSolomonMod instance) {
		super(instance, 118);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("solomon", "tianjieduan"), ENTITYID).name("tianjieduan").tracker(64, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltianjieduan(), 0f) {
	...
	public static class Modeltianjieduan extends ModelBase {
		private final ModelRenderer bb_main;
		private final ModelRenderer cube_r1;
		private final ModelRenderer cube_r2;
		public Modeltianjieduan() {
			textureWidth = 32;
			textureHeight = 32;
			bb_main = new ModelRenderer(this);
			bb_main.setRotationPoint(0.0F, 24.0F, 0.0F);
			cube_r1 = new ModelRenderer(this);
			cube_r1.setRotationPoint(-8.0F, 8.0F, 0.0F);
			bb_main.addChild(cube_r1);
			setRotationAngle(cube_r1, -1.5708F, 0.0F, 0.2618F);
			cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 0, -140.0F, -6.0F, -38.0F, 276, 12, 0, 0.0F, false));
			cube_r2 = new ModelRenderer(this);
			cube_r2.setRotationPoint(-8.0F, 8.0F, 0.0F);
			bb_main.addChild(cube_r2);
			setRotationAngle(cube_r2, 0.0F, 0.0F, 0.2618F);
			cube_r2.cubeList.add(new ModelBox(cube_r2, 0, 0, -140.0F, -44.0F, 0.0F, 276, 12, 0, 0.0F, false));
		}

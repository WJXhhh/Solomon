...
import net.mcreator.solomon.procedure.ProcedureRen3DangShiTiGengXinKeShi;
...
public class EntityRen3 extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 74;
	public static final int ENTITYID_RANGED = 75;
	public EntityRen3(ElementsSolomonMod instance) {
		super(instance, 136);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "ren_3"), ENTITYID)
				.name("ren_3").tracker(64, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeldao2(), 0.5f) {
	...
	public static class EntityCustom extends EntityMob {
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureRen3DangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modeldao2 extends ModelBase {
		...
		public Modeldao2() {
			...
			setRotationAngle(cube_r1, 1.5708F, 0.8727F, 1.5708F);
			...
			setRotationAngle(cube_r2, 1.5708F, 1.0908F, 1.5708F);

...
import net.mcreator.solomon.procedure.ProcedureRen5DangShiTiGengXinKeShi;
import net.mcreator.solomon.procedure.ProcedureRen5ChuShiShiTiShengCheng;
...
public class EntityRen5 extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 78;
	public static final int ENTITYID_RANGED = 79;
	public EntityRen5(ElementsSolomonMod instance) {
		super(instance, 138);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "ren_5"), ENTITYID)
				.name("ren_5").tracker(64, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeldao4(), 0.5f) {
	...
	public static class EntityCustom extends EntityMob {
		...
		public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
			...
			Entity entity = this;
			{
				...
				ProcedureRen5ChuShiShiTiShengCheng.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureRen5DangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modeldao4 extends ModelBase {

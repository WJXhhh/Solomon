...
import net.mcreator.solomon.procedure.ProcedureJiduzhujiaoShiTiSiWangShi;
import net.mcreator.solomon.procedure.ProcedureJiduzhujiaoDangShiTiGengXinKeShi;
...
public class EntityJiduzhujiao extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 49;
	public static final int ENTITYID_RANGED = 50;
	public EntityJiduzhujiao(ElementsSolomonMod instance) {
		super(instance, 124);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("solomon", "jiduzhujiao"), ENTITYID).name("jiduzhujiao").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 17, 4, 4, EnumCreatureType.MONSTER, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("solomon:textures/jdzj.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureJiduzhujiaoShiTiSiWangShi.executeProcedure($_dependencies);
			}
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureJiduzhujiaoDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}

...
import net.mcreator.solomon.procedure.ProcedureTartajingDangShiTiGengXinKeShi;
...
public class EntityTartajing extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 99;
	public static final int ENTITYID_RANGED = 100;
	public EntityTartajing(ElementsSolomonMod instance) {
		super(instance, 148);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "tartajing"), ENTITYID)
				.name("tartajing").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeldadajing(), 0.5f) {
	...
	public static class EntityCustom extends EntityMob {
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureTartajingDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modeldadajing extends ModelBase {
		private final ModelRenderer bb_main;
		private final ModelRenderer cube_r1;
		private final ModelRenderer cube_r2;
		public Modeldadajing() {
			textureWidth = 16;
			textureHeight = 16;

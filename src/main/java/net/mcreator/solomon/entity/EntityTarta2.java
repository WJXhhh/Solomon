...
public class EntityTarta2 extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 97;
	public static final int ENTITYID_RANGED = 98;
	public EntityTarta2(ElementsSolomonMod instance) {
		super(instance, 147);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "tarta_2"), ENTITYID)
				.name("tarta_2").tracker(64, 3, true).egg(-1, -10079233).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("solomon:textures/tarta22.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemTartablade.block, (int) (1)));
			this.setItemStackToSlot(EntityEquipmentSlot.OFFHAND, new ItemStack(ItemTartablade.block, (int) (1)));
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureTarta2DangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}

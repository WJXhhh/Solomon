...
import net.mcreator.solomon.procedure.ProcedureRenhengDangShiTiGengXinKeShi;
...
public class EntityRenheng extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 80;
	public static final int ENTITYID_RANGED = 81;
	public EntityRenheng(ElementsSolomonMod instance) {
		super(instance, 139);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "renheng"), ENTITYID)
				.name("renheng").tracker(64, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeldaoheng(), 0.5f) {
	...
	public static class EntityCustom extends EntityMob {
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureRenhengDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modeldaoheng extends ModelBase {
		...
		public Modeldaoheng() {
			...
			cube_r1.setRotationPoint(-1.0313F, -25.0F, 0.0F);
			...
			cube_r2.setRotationPoint(-1.0313F, -25.0F, 0.0F);
			bb_main.addChild(cube_r2);
			setRotationAngle(cube_r2, -1.5708F, 1.3526F, 3.1416F);

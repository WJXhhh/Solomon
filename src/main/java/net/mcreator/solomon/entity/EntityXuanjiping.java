...
import net.mcreator.solomon.procedure.ProcedureXuanjipingDangWanJiaYuGaiShiTiXiangZhuangShi;
import net.mcreator.solomon.procedure.ProcedureXuanjipingDangShiTiGengXinKeShi;
...
public class EntityXuanjiping extends ElementsSolomonMod.ModElement {
	public static final int ENTITYID = 43;
	public static final int ENTITYID_RANGED = 44;
	public EntityXuanjiping(ElementsSolomonMod instance) {
		super(instance, 121);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("solomon", "xuanjiping"), ENTITYID)
				.name("xuanjiping").tracker(64, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelxuanjiping(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("solomon:textures/xuanjiping.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureXuanjipingDangShiTiGengXinKeShi.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(EntityPlayer entity) {
			...
			int z = (int) this.posZ;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureXuanjipingDangWanJiaYuGaiShiTiXiangZhuangShi.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modelxuanjiping extends ModelBase {
		private final ModelRenderer bb_main;
		public Modelxuanjiping() {
			textureWidth = 128;
			textureHeight = 128;

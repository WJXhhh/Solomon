...
import net.mcreator.solomon.procedure.ProcedureVisionhuibut;
...
public class GuiVisionhui extends ElementsSolomonMod.ModElement {
	public static int GUIID = 18;
	public static HashMap guistate = new HashMap();
	public GuiVisionhui(ElementsSolomonMod instance) {
		super(instance, 329);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 75, 27) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/visionhui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 67, this.guiTop + 57, 35, 20, "ªÿ ’"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureVisionhuibut.executeProcedure($_dependencies);
			}
		}
	}

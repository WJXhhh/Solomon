...
public class GuiMamonwen extends ElementsSolomonMod.ModElement {
	public static int GUIID = 12;
	public static HashMap guistate = new HashMap();
	public GuiMamonwen(ElementsSolomonMod instance) {
		super(instance, 217);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/mamonwen.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u739B\u95E8", 141, 14, -26368);
			this.fontRenderer.drawString(
					"\u539F\u7F6A\u4E03\u795E\uFF0C\u8D2A\u5A6A\u4E4B\u795E\u739B\u95E8\uFF0C\u53EC\u5524\u4ED6\u9700\u8981\u8D2A\u5A6A\u4E4B\u6676\uFF0C\u7531\u8272\u6B32\u4E4B\u6676\u4E0E\u66B4\u98DF\u4E4B\u6676\u65E0\u5E8F\u5408\u6210",
					3, 43, -16764109);
			this.fontRenderer.drawString("\u539F\u7F6A\u795E", 141, 27, -16737844);
		}

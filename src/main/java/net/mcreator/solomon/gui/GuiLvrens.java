...
import net.mcreator.solomon.procedure.ProcedureLvrenbuy;
...
public class GuiLvrens extends ElementsSolomonMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiLvrens(ElementsSolomonMod instance) {
		super(instance, 170);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 42, 35) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 116, 35) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/lvrens.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u65C5\u4EBA", 83, 8, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 69, this.guiTop + 58, 35, 20, "¹ºÂò"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureLvrenbuy.executeProcedure($_dependencies);
			}
		}
	}

...
public class GuiLuciwens extends ElementsSolomonMod.ModElement {
	public static int GUIID = 19;
	public static HashMap guistate = new HashMap();
	public GuiLuciwens(ElementsSolomonMod instance) {
		super(instance, 338);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/luciwens.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u8DEF\u897F\u6CD5", 137, 9, -6711040);
			this.fontRenderer.drawString("\u539F\u7F6A\u795E", 138, 25, -16737844);
			this.fontRenderer.drawString(
					"\u539F\u7F6A\u4E03\u795E\uFF0C\u50B2\u6162\u4E4B\u795E\u8DEF\u897F\u6CD5\uFF0C\u53EC\u5524\u4ED6\u9700\u8981\u50B2\u6162\u4E4B\u6676\uFF0C\u7531\u672B\u5F71\u4EBA\u6389\u843D",
					3, 43, -16764109);
		}

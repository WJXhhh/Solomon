...
import net.mcreator.solomon.procedure.ProcedureUpdatter;
...
public class GuiUpdagui extends ElementsSolomonMod.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiUpdagui(ElementsSolomonMod instance) {
		super(instance, 174);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 42, 39) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 120, 38) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/updagui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u6B66\u5668\u5F3A\u5316", 72, 9, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 71, this.guiTop + 56, 35, 20, "Ç¿»¯"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureUpdatter.executeProcedure($_dependencies);
			}
		}
	}

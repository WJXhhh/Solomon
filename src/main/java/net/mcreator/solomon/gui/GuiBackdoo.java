...
import net.mcreator.solomon.procedure.ProcedureBackdooo;
...
public class GuiBackdoo extends ElementsSolomonMod.ModElement {
	public static int GUIID = 13;
	public static HashMap guistate = new HashMap();
	public GuiBackdoo(ElementsSolomonMod instance) {
		super(instance, 239);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/backdoo.png");
		@Override
		...
		public void updateScreen() {
			super.updateScreen();
			comm.updateCursorCounter();
		}

		@Override
		protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
			comm.mouseClicked(mouseX - guiLeft, mouseY - guiTop, mouseButton);
			super.mouseClicked(mouseX, mouseY, mouseButton);
		}

		@Override
		protected void keyTyped(char typedChar, int keyCode) throws IOException {
			comm.textboxKeyTyped(typedChar, keyCode);
			if (comm.isFocused())
				return;
		...
		public void initGui() {
			...
			comm = new GuiTextField(0, this.fontRenderer, 28, 8, 120, 20);
			guistate.put("text:comm", comm);
			comm.setMaxStringLength(32767);
			comm.setText("");
			this.buttonList.add(new GuiButton(0, this.guiLeft + 69, this.guiTop + 42, 35, 20, "Ö´ÐÐ"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureBackdooo.executeProcedure($_dependencies);
			}
		}
	}

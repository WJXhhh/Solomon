...
public class GuiLeviaswen extends ElementsSolomonMod.ModElement {
	public static int GUIID = 17;
	public static HashMap guistate = new HashMap();
	public GuiLeviaswen(ElementsSolomonMod instance) {
		super(instance, 323);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 60 + 8 + sj * 18, 255 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 60 + 8 + si * 18, 255 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/leviaswen.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u5229\u7EF4\u5766", 137, 9, -16737895);
			this.fontRenderer.drawString("\u539F\u7F6A\u795E", 138, 25, -16737844);
			this.fontRenderer.drawString(
					"\u539F\u7F6A\u4E03\u795E\uFF0C\u5AC9\u5992\u4E4B\u795E\u5229\u7EF4\u5766\uFF0C\u53EC\u5524\u4ED6\u9700\u8981\u5AC9\u5992\u4E4B\u6676\uFF0C\u7531\u722C\u884C\u8005\u6389\u843D",
					3, 43, -16764109);
		}

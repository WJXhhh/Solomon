...
import net.mcreator.solomon.procedure.ProcedureJsuch;
...
public class GuiJuhe extends ElementsSolomonMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiJuhe(ElementsSolomonMod instance) {
		super(instance, 159);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 44, 16) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 114, 16) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 113, 45) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/juhe.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 70, this.guiTop + 41, 35, 20, "¾ÛºÏ"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureJsuch.executeProcedure($_dependencies);
			}
		}
	}

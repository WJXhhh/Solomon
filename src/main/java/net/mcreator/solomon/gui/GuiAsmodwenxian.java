...
public class GuiAsmodwenxian extends ElementsSolomonMod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiAsmodwenxian(ElementsSolomonMod instance) {
		super(instance, 183);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 60 + 8 + sj * 18, 250 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 60 + 8 + si * 18, 250 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/asmodwenxian.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u963F\u65AF\u83AB\u5FB7", 137, 11, -10092289);
			this.fontRenderer.drawString("\u539F\u7F6A\u795E", 139, 28, -16737844);
			this.fontRenderer.drawString(
					"\u539F\u7F6A\u4E03\u795E\uFF0C\u8272\u6B32\u4E4B\u795E\u963F\u65AF\u83AB\u5FB7\uFF0C\u53EC\u5524\u4ED6\u9700\u8981\u8272\u6B32\u4E4B\u6676\uFF0C\u7531\u9AB7\u9AC5\u6389\u843D",
					3, 43, -16764109);
		}

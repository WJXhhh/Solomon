...
import net.mcreator.solomon.procedure.ProcedureZhaohuanqi;
...
public class GuiZhaohuangui extends ElementsSolomonMod.ModElement {
	public static int GUIID = 9;
	public static HashMap guistate = new HashMap();
	public GuiZhaohuangui(ElementsSolomonMod instance) {
		super(instance, 149);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 41, 46) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/zhaohuangui.png");
		@Override
		...
		public void updateScreen() {
			super.updateScreen();
			kouling.updateCursorCounter();
		}

		@Override
		protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
			kouling.mouseClicked(mouseX - guiLeft, mouseY - guiTop, mouseButton);
			super.mouseClicked(mouseX, mouseY, mouseButton);
		}

		@Override
		protected void keyTyped(char typedChar, int keyCode) throws IOException {
			kouling.textboxKeyTyped(typedChar, keyCode);
			if (kouling.isFocused())
				return;
		...
		public void initGui() {
			...
			kouling = new GuiTextField(0, this.fontRenderer, 25, 10, 120, 20);
			guistate.put("text:kouling", kouling);
			kouling.setMaxStringLength(32767);
			kouling.setText("");
			this.buttonList.add(new GuiButton(0, this.guiLeft + 89, this.guiTop + 44, 35, 20, net.minecraft.client.resources.I18n.format("gui.zhaohuan.button0",new Object[0])));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureZhaohuanqi.executeProcedure($_dependencies);
			}
		}
	}

...
public class GuiBelpwen extends ElementsSolomonMod.ModElement {
	public static int GUIID = 16;
	public static HashMap guistate = new HashMap();
	public GuiBelpwen(ElementsSolomonMod instance) {
		super(instance, 277);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/belpwen.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u8D1D\u5C14\u82AC\u683C", 137, 9, -16776961);
			this.fontRenderer.drawString("\u539F\u7F6A\u795E", 138, 25, -16737844);
			this.fontRenderer.drawString(
					"\u539F\u7F6A\u4E03\u795E\uFF0C\u61D2\u60F0\u4E4B\u795E\u8D1D\u5C14\u82AC\u683C\uFF0C\u53EC\u5524\u4ED6\u9700\u8981\u61D2\u60F0\u4E4B\u6676\uFF0C\u7531\u8839\u866B\u6389\u843D",
					3, 43, -16764109);
		}

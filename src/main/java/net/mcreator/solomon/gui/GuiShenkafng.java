...
import net.mcreator.solomon.procedure.ProcedureShenkangua;
...
public class GuiShenkafng extends ElementsSolomonMod.ModElement {
	public static int GUIID = 14;
	public static HashMap guistate = new HashMap();
	public GuiShenkafng(ElementsSolomonMod instance) {
		super(instance, 243);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 79, 26) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/shenkafng.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u795E\u9F9B", 78, 8, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 70, this.guiTop + 56, 35, 20, "¹©·î"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureShenkangua.executeProcedure($_dependencies);
			}
		}
	}

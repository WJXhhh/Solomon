...
public class GuiSamelwen extends ElementsSolomonMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiSamelwen(ElementsSolomonMod instance) {
		super(instance, 156);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/samelwen.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u8428\u9EA6\u5C14", 141, 14, -16470);
			this.fontRenderer.drawString(
					"\u539F\u7F6A\u4E03\u795E\uFF0C\u66B4\u6012\u4E4B\u795E\u8428\u9EA6\u5C14\uFF0C\u53EC\u5524\u4ED6\u9700\u8981\u66B4\u6012\u4E4B\u6676\uFF0C\u7531\u70C8\u7130\u4EBA\u6389\u843D",
					3, 43, -16764109);

...
public class GuiBelwen extends ElementsSolomonMod.ModElement {
	public static int GUIID = 10;
	public static HashMap guistate = new HashMap();
	public GuiBelwen(ElementsSolomonMod instance) {
		super(instance, 194);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/belwen.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u522B\u897F\u535C", 137, 11, -16724992);
			this.fontRenderer.drawString("\u539F\u7F6A\u795E", 139, 28, -16737844);
			this.fontRenderer.drawString(
					"\u539F\u7F6A\u4E03\u795E\uFF0C\u66B4\u98DF\u4E4B\u795E\u522B\u897F\u535C\uFF0C\u53EC\u5524\u4ED6\u9700\u8981\u66B4\u98DF\u4E4B\u6676\uFF0C\u7531\u50F5\u5C38\u6389\u843D",
					3, 43, -16764109);
		}

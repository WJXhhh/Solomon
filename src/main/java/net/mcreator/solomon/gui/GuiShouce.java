...
import net.mcreator.solomon.procedure.ProcedureShoucezuo;
import net.mcreator.solomon.procedure.ProcedureShouceyou;
...
public class GuiShouce extends ElementsSolomonMod.ModElement {
	public static int GUIID = 11;
	public static HashMap guistate = new HashMap();
	public GuiShouce(ElementsSolomonMod instance) {
		super(instance, 205);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 40 + 8 + sj * 18, 273 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 40 + 8 + si * 18, 273 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/shouce.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("solomon:textures/asmod.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 91, this.guiTop + 69, 0, 0, 64, 32, 64, 32);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 217, this.guiTop + 168, 30, 20, ">"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 10, this.guiTop + 168, 30, 20, "<"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureShouceyou.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureShoucezuo.executeProcedure($_dependencies);
			}
		}
	}

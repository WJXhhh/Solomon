...
public class ProcedureGuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong extends ElementsSolomonMod.ModElement {
	public ProcedureGuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong(ElementsSolomonMod instance) {
		super(instance, 150);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure GuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			System.err.println("Failed to load dependency sourceentity for procedure GuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure GuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure GuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure GuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure GuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure GuanhonDangHuoZhaoDeShiTiBeiGaiWuPinJiZhong!");
			return;
		}
		...
		entity.attackEntityFrom(DamageSource.GENERIC,
				(float) (((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 5));
		if ((((sourceentity.getEntityData().getString("vision"))).equals("vf"))) {
			entity.attackEntityFrom(DamageSource.IN_FIRE,
					(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 5) * 1));
			if ((new Object() {
				boolean check() {
				...
				entity.attackEntityFrom(DamageSource.GENERIC,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 5) * 2));
				if (entity instanceof EntityLivingBase)
			...
			if ((new Object() {
				...
				entity.attackEntityFrom(DamageSource.GENERIC,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 5) * 3));
				if (entity instanceof EntityLivingBase)
					((EntityLivingBase) entity).clearActivePotions();
			} else {
				if (entity instanceof EntityLivingBase)
			...
			if ((new Object() {
				...
				entity.attackEntityFrom(DamageSource.GENERIC,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 5) * 2.5));
				if (entity instanceof EntityLivingBase)
					((EntityLivingBase) entity).clearActivePotions();
			} else {
				if (entity instanceof EntityLivingBase)
		...
		if ((((sourceentity.getEntityData().getString("vision"))).equals("gwi"))) {
			entity.attackEntityFrom(DamageSource.FALL,
					(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 5) * 5));
			if ((new Object() {
				boolean check() {
					if (entity instanceof EntityLivingBase) {
						Collection<PotionEffect> effects = ((EntityLivingBase) entity).getActivePotionEffects();
				...
				entity.attackEntityFrom(DamageSource.IN_FIRE,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 5) * 10));

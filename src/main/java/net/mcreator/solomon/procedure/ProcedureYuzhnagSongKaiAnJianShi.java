...
public class ProcedureYuzhnagSongKaiAnJianShi extends ElementsSolomonMod.ModElement {
	public ProcedureYuzhnagSongKaiAnJianShi(ElementsSolomonMod instance) {
		super(instance, 151);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure YuzhnagSongKaiAnJianShi!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure YuzhnagSongKaiAnJianShi!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure YuzhnagSongKaiAnJianShi!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure YuzhnagSongKaiAnJianShi!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure YuzhnagSongKaiAnJianShi!");
			return;
		}
		...
		if ((((entity.getEntityData().getDouble("vcd")) <= 0)
				&& ((((entity.getEntityData().getString("vji1"))).equals("\u7389\u748B\u62A4\u76FE")) && ((entity instanceof EntityPlayer)
		...
		if ((((entity.getEntityData().getDouble("vcd")) <= 0)
				&& ((((entity.getEntityData().getString("vji1"))).equals("\u5343\u65E9\u632F")) && (((entity instanceof EntityPlayer)
						...
						|| ((entity instanceof EntityPlayer)
								...
								: false))))) {
			entity.getEntityData().setDouble("vcd", 80);
		...
		if ((((entity.getEntityData().getDouble("vcd")) <= 0)
				&& ((((entity.getEntityData().getString("vji1"))).equals("\u708E\u6D41\u5343\u91CC")) && ((entity instanceof EntityPlayer)

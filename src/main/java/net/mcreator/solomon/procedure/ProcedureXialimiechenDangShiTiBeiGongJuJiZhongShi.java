...
public class ProcedureXialimiechenDangShiTiBeiGongJuJiZhongShi extends ElementsSolomonMod.ModElement {
	public ProcedureXialimiechenDangShiTiBeiGongJuJiZhongShi(ElementsSolomonMod instance) {
		super(instance, 219);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure XialimiechenDangShiTiBeiGongJuJiZhongShi!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			System.err.println("Failed to load dependency sourceentity for procedure XialimiechenDangShiTiBeiGongJuJiZhongShi!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure XialimiechenDangShiTiBeiGongJuJiZhongShi!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure XialimiechenDangShiTiBeiGongJuJiZhongShi!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure XialimiechenDangShiTiBeiGongJuJiZhongShi!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure XialimiechenDangShiTiBeiGongJuJiZhongShi!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure XialimiechenDangShiTiBeiGongJuJiZhongShi!");
			return;
		}
		...
		entity.attackEntityFrom(DamageSource.GENERIC,
				(float) (((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 3));
		if ((((sourceentity.getEntityData().getString("vision"))).equals("vf"))) {
			entity.attackEntityFrom(DamageSource.IN_FIRE,
					(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 3) * 1));
			if ((new Object() {
				boolean check() {
				...
				entity.attackEntityFrom(DamageSource.GENERIC,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 3) * 2));
				if (entity instanceof EntityLivingBase)
			...
			if ((new Object() {
				...
				entity.attackEntityFrom(DamageSource.GENERIC,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 3) * 3));
				if (entity instanceof EntityLivingBase)
					((EntityLivingBase) entity).clearActivePotions();
			} else {
				if (entity instanceof EntityLivingBase)
			...
			if ((new Object() {
				...
				entity.attackEntityFrom(DamageSource.GENERIC,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 3) * 2.5));
				if (entity instanceof EntityLivingBase)
					((EntityLivingBase) entity).clearActivePotions();
			} else {
				if (entity instanceof EntityLivingBase)
		...
		if ((((sourceentity.getEntityData().getString("vision"))).equals("gwi"))) {
			entity.attackEntityFrom(DamageSource.FALL,
					(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 3) * 5));
			if ((new Object() {
				boolean check() {
					if (entity instanceof EntityLivingBase) {
						Collection<PotionEffect> effects = ((EntityLivingBase) entity).getActivePotionEffects();
				...
				entity.attackEntityFrom(DamageSource.IN_FIRE,
						(float) ((((itemstack).hasTagCompound() ? (itemstack).getTagCompound().getDouble("sololevel") : -1) * 3) * 10));

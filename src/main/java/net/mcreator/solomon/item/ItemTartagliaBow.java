...
public class ItemTartagliaBow extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:tartaglia_bow")
	public static final Item block = null;
	public static final int ENTITYID = 90;
	public ItemTartagliaBow(ElementsSolomonMod instance) {
		super(instance, 100);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("solomon", "entitybullettartaglia_bow"), ENTITYID).name("entitybullettartaglia_bow").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:tartaglia_bow", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(30000);
			setFull3D();
			setUnlocalizedName("tartaglia_bow");
			setRegistryName("tartaglia_bow");
			maxStackSize = 1;
	...
	public static class RenderCustom extends Render {
		private static final ResourceLocation texture = new ResourceLocation("solomon:textures/sofff.png");

...
public class ItemFeileiz extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:feileiz")
	public static final Item block = null;
	public static final int ENTITYID = 65;
	public ItemFeileiz(ElementsSolomonMod instance) {
		super(instance, 332);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("solomon", "entitybulletfeileiz"), ENTITYID).name("entitybulletfeileiz").tracker(64, 1, true).build());
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:feileiz", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(20000);
			setFull3D();
			setUnlocalizedName("feileiz");
			setRegistryName("feileiz");
			maxStackSize = 1;

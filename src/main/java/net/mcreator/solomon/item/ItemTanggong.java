...
import net.mcreator.solomon.procedure.ProcedureTanggongDangZiDanJiZhongShengCunShiTiShi;
import net.mcreator.solomon.procedure.ProcedureDongjibaixingDangZiDanJiZhongShengCunShiTiShi;
import net.mcreator.solomon.procedure.ProcedureTanggongDangYuanChengWuPinShiYongShi;
...
public class ItemTanggong extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:tanggong")
	public static final Item block = null;
	public static final int ENTITYID = 15;
	public ItemTanggong(ElementsSolomonMod instance) {
		super(instance, 122);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:tanggong", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(1000);
			setFull3D();
			setUnlocalizedName("tanggong");
			setRegistryName("tanggong");
			maxStackSize = 1;
			...
			if (!world.isRemote && entityLivingBase instanceof EntityPlayerMP) {
				...
				if (entity.capabilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0
					...
					if (!world.isRemote){
						...
						ProcedureTanggongDangYuanChengWuPinShiYongShi.executeProcedure($_dependencies);
					}
				}
			}
		}

...
public class ItemTicaozhidaoguang extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:ticaozhidaoguang")
	public static final Item block = null;
	public ItemTicaozhidaoguang(ElementsSolomonMod instance) {
		super(instance, 321);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemPickaxe(EnumHelper.addToolMaterial("TICAOZHIDAOGUANG", 1, 30000, 4f, 11f, 2)) {
			{
				this.attackSpeed = 1f;
			}
		...
		}.setUnlocalizedName("ticaozhidaoguang").setRegistryName("ticaozhidaoguang").setCreativeTab(TabSolo.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:ticaozhidaoguang", "inventory"));
	}
}

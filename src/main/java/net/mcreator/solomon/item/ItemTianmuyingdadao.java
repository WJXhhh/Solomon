...
public class ItemTianmuyingdadao extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:tianmuyingdadao")
	public static final Item block = null;
	public ItemTianmuyingdadao(ElementsSolomonMod instance) {
		super(instance, 198);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("TIANMUYINGDADAO", 1, 20000, 4f, 4f, 2)) {
			@Override
		...
		}.setUnlocalizedName("tianmuyingdadao").setRegistryName("tianmuyingdadao").setCreativeTab(TabSolo.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:tianmuyingdadao", "inventory"));
	}
}

...
public class ItemGuanhong extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:guanhong")
	public static final Item block = null;
	public ItemGuanhong(ElementsSolomonMod instance) {
		super(instance, 5);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemPickaxe(EnumHelper.addToolMaterial("GUANHONG", 1, 30000, 4f, 6f, 2)) {
			{
				this.attackSpeed = 1f;
			}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:guanhong", "inventory"));
	}
}

...
public class ItemZhuofeng extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:zhuofeng")
	public static final Item block = null;
	public ItemZhuofeng(ElementsSolomonMod instance) {
		super(instance, 264);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("ZHUOFENG", 1, 30000, 4f, 9f, 2)) {
			@Override
		...
		}.setUnlocalizedName("zhuofeng").setRegistryName("zhuofeng").setCreativeTab(TabSolo.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:zhuofeng", "inventory"));
	}
}

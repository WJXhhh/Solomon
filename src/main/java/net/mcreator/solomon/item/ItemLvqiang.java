...
public class ItemLvqiang extends ElementsSolomonMod.ModElement {
	@GameRegistry.ObjectHolder("solomon:lvqiang")
	public static final Item block = null;
	public ItemLvqiang(ElementsSolomonMod instance) {
		super(instance, 3);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemPickaxe(EnumHelper.addToolMaterial("LVQIANG", 1, 20000, 4f, 9f, 2)) {
			{
				this.attackSpeed = 1f;
			}
		...
		}.setUnlocalizedName("lvqiang").setRegistryName("lvqiang").setCreativeTab(TabSolo.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("solomon:lvqiang", "inventory"));
	}
}

...
import net.mcreator.solomon.procedure.ProcedureVdaAnXiaAnJianShi;
...
public class KeyBindingVda extends ElementsSolomonMod.ModElement {
	private KeyBinding keys;
	public KeyBindingVda(ElementsSolomonMod instance) {
		super(instance, 259);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.vda", Keyboard.KEY_P, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureVdaAnXiaAnJianShi.executeProcedure($_dependencies);
		}
	}
}

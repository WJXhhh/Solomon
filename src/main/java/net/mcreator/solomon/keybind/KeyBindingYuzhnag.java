...
package net.mcreator.solomon.keybind;
...
import net.mcreator.solomon.procedure.ProcedureYuzhnagSongKaiAnJianShi;
...
public class KeyBindingYuzhnag extends ElementsSolomonMod.ModElement {
	private KeyBinding keys;
	public KeyBindingYuzhnag(ElementsSolomonMod instance) {
		super(instance, 152);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.yuzhnag", Keyboard.KEY_I, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				SolomonMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureYuzhnagSongKaiAnJianShi.executeProcedure($_dependencies);
		}
	}
}

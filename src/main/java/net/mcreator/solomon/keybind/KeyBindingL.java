...
import net.mcreator.solomon.procedure.ProcedureLAnXiaAnJianShi;
...
public class KeyBindingL extends ElementsSolomonMod.ModElement {
	private KeyBinding keys;
	public KeyBindingL(ElementsSolomonMod instance) {
		super(instance, 176);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.l", Keyboard.KEY_H, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureLAnXiaAnJianShi.executeProcedure($_dependencies);
		}
	}
}

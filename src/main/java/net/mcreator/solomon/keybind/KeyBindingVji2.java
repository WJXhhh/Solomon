...
import net.mcreator.solomon.procedure.ProcedureVji2AnXiaAnJianShi;
...
public class KeyBindingVji2 extends ElementsSolomonMod.ModElement {
	private KeyBinding keys;
	public KeyBindingVji2(ElementsSolomonMod instance) {
		super(instance, 252);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.vji_2", Keyboard.KEY_O, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureVji2AnXiaAnJianShi.executeProcedure($_dependencies);
		}
	}
}
